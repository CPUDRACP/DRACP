            ...
            <div style="padding: 12px;background-color: #f7f7f7;border: 1px solid #ddd;border-radius: 12px;">
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <p>
                            <span style="color: #77370B;font-weight: bold">PI</span>&nbsp; <?php echo $row['pI']?>
                        </p>
                        <p>
...
//                Patent
                    //Patent ID   对应Patent_ID字段 谷歌专利链接https://www.google.com/patents/
                    //Patent Title  对应Patent_Title 字段
                    //Other Iinformation 对应Other_Information 字段
                    //Other Published ID 对应Other_Published_ID 谷歌专利链接https://www.google.com/patents/
