...
<div class="container" style="padding-bottom:100px;">
    ...
    <?php
        $sq="select * from peptidedrug  where $tit like '%$tcont%'  order by DRACPC_ID asc";
    ...
    <div class="row">
            ...
            $sqld="select * from peptidedrug  where $tit like '%$tcont%'  order by DRACPC_ID asc limit $start,$pagesize";
                ...
                echo '<div class="drugcard">
                    <div class="drugcard-con">
                        <p class="drugcard-title">
                            ...
                            <a target="_blank" href="content.php?id='.$row['DRACPC_ID'].'" style="color: #165f37;">'.$row['DRACPC_ID'].'</a>
                        </p>
...
<div class="container mt-5">
    ...
    <div class="text-right mb-5">
        ...
        echo ' <a href="PeptideDrug.php?page=1&slt='.$tit.'&txtarea='.$tcont.'" class="btn btn-default btn-page"><<</a> ';
        if($page>$start){
            $pagepre=$page-1;
            echo '<a href="drug_search.php?page='.$pagepre.'&slt='.$tit.'&txtarea='.$tcont.'" class="btn btn-default btn-page"><</a>';
        }else{
            echo ' <a href="drug_search.php?page='.$start.'&slt='.$tit.'&txtarea='.$tcont.'" class="btn btn-default btn-page"><</a> ';
        }
        ...
        if($pagecount>$showpages){
            ...
            for($i=$start;$i<=$end;$i++){
                if($i==$page){
                    echo ' <a href="drug_search.php?page='.$i.'&slt='.$tit.'&txtarea='.$tcont.'" class="btn btn-primary btn-page">'.$i.'</a> ';
                }else{
                    echo ' <a href="drug_search.php?page='.$i.'&slt='.$tit.'&txtarea='.$tcont.'" class="btn btn-default btn-page" >'.$i.'</a> ';
                }
            }
        }else{
            for($i=$start;$i<=$end;$i++) {
        ...
        echo ' <a href="PeptideDrug.php?page='.$pagecount.'&slt='.$tit.'&txtarea='.$tcont.'" class="btn btn-default btn-page">>></a> ';
