...
if($r){
    echo '<script>alert("Submitted successfully, thank you！");location.href="http://dracp.cpu-bioinfor.org/"</script>';
    exit;
}else{
    echo '<script>location.href="http://dracp.cpu-bioinfor.org/"</script>';
    exit;
}