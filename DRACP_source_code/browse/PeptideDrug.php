...
<div class="container" style="padding-bottom:100px;">
    <div class="row" style="padding-top:80px;">
        <ol class="breadcrumb">
            ...
            <li class="active">Drug Libraray</li>
        </ol>
    </div>
    ...
    <?php
        $sq="select * from peptidedrug    order by DRACPC_ID asc";
    ...
    <div class="row">
            ...
            $sqld="select * from peptidedrug    order by DRACPC_ID asc limit $start,$pagesize";
...
<div class="container mt-5">
    ...
    <div class="text-right mb-5">
        ...
        echo ' <a href="PeptideDrug.php?page=1" class="btn btn-default btn-page"><<</a> ';
        if($page>$start){
            $pagepre=$page-1;
            echo '<a href="PeptideDrug.php?page='.$pagepre.'" class="btn btn-default btn-page"><</a>';
        }else{
            echo ' <a href="PeptideDrug.php?page='.$start.'" class="btn btn-default btn-page"><</a> ';
        }
        ...
        if($pagecount>$showpages){
            ...
            for($i=$start;$i<=$end;$i++){
                if($i==$page){
                    echo ' <a href="PeptideDrug.php?page='.$i.'" class="btn btn-primary btn-page">'.$i.'</a> ';
                }else{
                    echo ' <a href="PeptideDrug.php?page='.$i.'" class="btn btn-default btn-page" >'.$i.'</a> ';
                }
            }
        }else{
            for($i=$start;$i<=$end;$i++) {
        ...
        echo ' <a href="PeptideDrug.php?page='.$pagecount.'" class="btn btn-default btn-page">>></a> ';
        ?>
